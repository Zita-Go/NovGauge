"""Judge whether the evidence supports the reason for a predicted paper group."""
...
def build_prompt(dim: str, evidence_map: dict, reason: str) -> str:
    """Build a judge prompt from a mapping of paper indices to evidence and a reason."""
...
def process_group(record: dict, group_idx: int, cfg: LLMConfig) -> dict:
    """Check reasoning for one group and return its identifiers, verdict, and critique."""
