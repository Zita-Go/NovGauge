"""Predict paper groups for each evaluated dimension. Use --help for options."""
...
DEFAULT_MAX_ABSTRACT_TOKENS  = 1000
DEFAULT_MAX_INTRO_TOKENS     = 4000
DEFAULT_MAX_FULL_TOKENS      = 16000
...
def main():
    ...
    parser.add_argument("--content-modes", nargs="+", default=["full"],
